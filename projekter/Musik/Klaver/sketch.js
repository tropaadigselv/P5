...
function draw(){
  ...
  //de hvide
  if( (mouseIsPressed)){
    if(((mouseX>0 && mouseX <50) && (mouseY>205 && mouseY<250))||((mouseX>15 && mouseX<35) && (mouseY > 125 && mouseY < 205))){
      //q
      Node1.play();
      
    }else if(((mouseX>50 && mouseX <100) && (mouseY>205 && mouseY<250))||((mouseX>65 && mouseX<100) && (mouseY > 125 && mouseY < 205))){
      //w
      Node2.play();
    }else if (((mouseX>100 && mouseX <150) && (mouseY>205 && mouseY<250))||((mouseX>100 && mouseX<135) && (mouseY > 125 && mouseY < 205))){
      //e
      Node3.play();
    }else if (((mouseX>150 && mouseX <200) && (mouseY>205 && mouseY<250))||((mouseX>165 && mouseX<185) && (mouseY > 125 && mouseY < 205))){
      //r
      Node4.play();

    }else if (((mouseX>200 && mouseX <250) && (mouseY>205 && mouseY<250))||((mouseX>215 && mouseX<235) && (mouseY > 125 && mouseY < 205))){
      //t
      Node5.play();

    }else if (((mouseX>250 && mouseX <300) && (mouseY>205 && mouseY<250))||((mouseX>265 && mouseX<300) && (mouseY > 125 && mouseY < 205))){
      //y
      Node6.play();

    }else if (((mouseX>300 && mouseX <350) && (mouseY>205 && mouseY<250))||((mouseX>300 && mouseX<335) && (mouseY > 125 && mouseY < 205))){
      //u
      Node7.play();

    }else if (((mouseX>350 && mouseX <400) && (mouseY>205 && mouseY<250))||((mouseX>365 && mouseX<385) && (mouseY > 125 && mouseY < 205))){
      //i
      Node8.play();

    }else if (((mouseX>400 && mouseX <450) && (mouseY>205 && mouseY<250))||((mouseX>415 && mouseX<450) && (mouseY > 125 && mouseY < 205))){
      //o
      Node9.play();

    }else if (((mouseX>450 && mouseX <500) && (mouseY>205 && mouseY<250))||((mouseX>450 && mouseX<485) && (mouseY > 125 && mouseY < 205))){
      //p
      Node10.play();

    }else if (((mouseX>500 && mouseX <550) && (mouseY>205 && mouseY<250))||((mouseX>515 && mouseX<535) && (mouseY > 125 && mouseY < 205))){
      //å
      Node11.play();

    }else if (((mouseX>550 && mouseX <600) && (mouseY>205 && mouseY<250))||((mouseX>565 && mouseX<585) && (mouseY > 125 && mouseY < 205))){
      //z
      Node12.play();
    
    }else if (((mouseX>600 && mouseX <650) && (mouseY>205 && mouseY<250))||((mouseX>615 && mouseX<650) && (mouseY > 125 && mouseY < 205))){
      //x
      Node13.play();

    }else if (((mouseX>650 && mouseX <700) && (mouseY>205 && mouseY<250))||((mouseX>650 && mouseX<685) && (mouseY > 125 && mouseY < 205))){
      //c
      Node14.play();
    }
    // de sorte
